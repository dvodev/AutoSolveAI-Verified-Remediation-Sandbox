...
Before submitting, record the exact public repository URL, video URL, and Codex session ID in `SUBMISSION.md`. Do not claim that legacy production code was built during the challenge.
